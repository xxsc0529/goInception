...
type IncLevel struct {
	...
	ErCantAddAutoIncrementColumn                 uint8 `toml:"er_cant_add_auto_increment_column"`
	ErCantAddColumnsAndConstraintsInOneStatement uint8 `toml:"er_cant_add_columns_and_constraints_in_one_statement"`
	ErCantAddPrimaryKey                          uint8 `toml:"er_cant_add_primary_key"`
	ErCantAddStoredGeneratedColumn               uint8 `toml:"er_cant_add_stored_generated_column"`
	ErCantAlterPartitionRule                     uint8 `toml:"er_cant_alter_partition_rule"`
	ErCantChangeColumn                           uint8 `toml:"er_cant_change_column"`
	ErCantChangeColumnPosition                   uint8 `toml:"er_cant_change_column_position"`
	ErCantDropColumn                             uint8 `toml:"er_cant_drop_column"`
	ErCantDropDatabase                           uint8 `toml:"er_cant_drop_database"`
	ErCantDropFieldOrKey                         uint8 `toml:"er_cant_drop_field_or_key"`
	ErCantDropPartition                          uint8 `toml:"er_cant_drop_partition"`
	ErCantDropPrimaryKey                         uint8 `toml:"er_cant_drop_primary_key"`
	ErCantDropTable                              uint8 `toml:"er_cant_drop_table"`
	ErCantModifyAutoIncrementColumn              uint8 `toml:"er_cant_modify_auto_increment_column"`
	ErCantModifyPkOrUkColumn                     uint8 `toml:"er_cant_modify_pk_or_uk_column"`
	...
	ErCantTruncatePartition                      uint8 `toml:"er_cant_truncate_partition"`
	ErCantTruncateTable                          uint8 `toml:"er_cant_truncate_table"`
	...
	ErNotAllowMultiAlterStatementInOneStatement  uint8 `toml:"er_not_allow_multi_alter_statement_in_one_statement"`
	...
	ErNotSupportFeatureOrFunctionForOb3          uint8 `toml:"er_not_support_feature_or_function_for_ob3"`
	...
	ErToolBasedUniqueIndexWarning                uint8 `toml:"er_tool_based_unique_index_warning"`
...
var defaultLevel = IncLevel{
	...
	ErBlobUsedAsKey:                              2,
	ErCantAddAutoIncrementColumn:                 1,
	ErCantAddColumnsAndConstraintsInOneStatement: 1,
	ErCantAddPrimaryKey:                          1,
	ErCantAddStoredGeneratedColumn:               1,
	ErCantAlterPartitionRule:                     1,
	ErCantChangeColumn:                           1,
	ErCantChangeColumnPosition:                   1,
	ErCantDropColumn:                             1,
	ErCantDropDatabase:                           2,
	ErCantDropFieldOrKey:                         2,
	ErCantDropPartition:                          1,
	ErCantDropPrimaryKey:                         1,
	ErCantDropTable:                              1,
	ErCantModifyAutoIncrementColumn:              1,
	ErCantModifyPkOrUkColumn:                     1,
	ErCantRemoveAllFields:                        2,
	ErCantSetCharset:                             1,
	ErCantSetCollation:                           1,
	ErCantSetEngine:                              1,
	ErCantTruncatePartition:                      1,
	ErCantTruncateTable:                          1,
	...
	ErNonUniqTable:                               2,
	ErNormalShutdown:                             2,
	ErNotAllowMultiAlterStatementInOneStatement:  2,
	ErNotAllowedNullable:                         1,
	ErNotFoundMasterStatus:                       2,
	ErNotFoundTableInfo:                          1,
	ErNotSupportFeatureOrFunctionForOb3:          2,
	...
	ErToolBasedUniqueIndexWarning:                1,
